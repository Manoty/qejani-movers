...
export default function LoginPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true)
    try {
      await loginCustomer(form.phone, form.password)
    ...
    <div style={{
      ...
      <div className="animate-fade-up" style={{ width: '100%', maxWidth: 420 }}>
        <div style={{ textAlign: 'center', marginBottom: 36 }}>
          ...
          <h1 className="serif" style={{ fontSize: 28, color: 'var(--forest)' }}>Welcome back</h1>
          <p style={{ fontSize: 14, color: 'var(--muted)', marginTop: 6 }}>Sign in to your Qejani account</p>
        </div>
        ...
        <div style={{
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 18 }}>
            ...
            <Button type="submit" size="lg" loading={loading} style={{ justifyContent: 'center' }}>
              Sign in
            </Button>
          </form>
        </div>
